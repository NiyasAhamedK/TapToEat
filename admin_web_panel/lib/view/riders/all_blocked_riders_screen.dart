...
class _AllBlockedRidersScreenState extends State<AllBlockedRidersScreen>
{
  ...
  displayDialogBoxForApprovingAccount(riderDocumentID)
  {
    return showDialog(
        context: context,
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: ()
                    {
                      displayDialogBoxForApprovingAccount(allRiders!.docs[i].id);
                    },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppbar(titleMsg: "All Blocked Riders Accounts", showBackButton: true),
      body: Center(
        child: Container(
          width: MediaQuery.of(context).size.width * .5,
          child: displayBlockedRidersUI(),
        ),
      ),
    );
  }
