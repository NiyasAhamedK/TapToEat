...
class _AllBlockedSellersScreenState extends State<AllBlockedSellersScreen>
{
  ...
  void initState() {
    ...
    {
      setState(() {
        allSellers = allBlockedSellers;
      });
    });
  }

  displayDialogBoxForApprovingAccount(sellerDocumentID)
  {
    return showDialog(
        context: context,
  ...
  Widget displayBlockedSellersUI()
  {
    if(allSellers != null)
    {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: ()
                    {
                      displayDialogBoxForApprovingAccount(allSellers!.docs[i].id);
                    },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppbar(titleMsg: "All Blocked Sellers Accounts", showBackButton: true),
      body: Center(
        child: Container(
          width: MediaQuery.of(context).size.width * .5,
          child: displayBlockedSellersUI(),
        ),
      ),
    );
  }
